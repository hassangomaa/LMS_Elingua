    ...
    <section class="sms-breadcrumb mb-20 white-box">
        <div class="container-fluid">
            <div class="row justify-content-between">
                <h1><?php echo e(__('frontendmanage.Become Instructor')); ?></h1>
                <div class="bc-pages">
                    <a href="<?php echo e(route('dashboard')); ?>"><?php echo e(__('common.Dashboard')); ?></a>
                    <a href="#"><?php echo e(__('frontendmanage.Frontend CMS')); ?></a>
                    <a class="active"
                       href="<?php echo e(url('frontend/becomeInstructor')); ?>"><?php echo e(__('frontendmanage.Become Instructor')); ?></a>
                </div>
            </div>
        </div>
    </section>
...
<?php echo $__env->make('backend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hassangomaa/Documents/Laravel_projects/noLicenceLMS/LMS_Elingua/Modules/FrontendManage/Resources/views/becomeInstructor.blade.php ENDPATH**/ ?>