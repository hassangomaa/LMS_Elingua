    ...
    <section class="sms-breadcrumb mb-40 white-box">
        <div class="container-fluid">
            <div class="row justify-content-between">
                <h1><?php echo e(__('coupons.Personalized Coupons List')); ?></h1>
                <div class="bc-pages">
            ...
            <div class="row">
                        ...
                        <div class="col-12">
                            <div class="box_header common_table_header">
                                <div class="main-title d-md-flex">
                                    ...
                                    <?php if(isset($edit)): ?>
                                        <?php if(permissionCheck('coupons.personalized.store')): ?>
                                        ...
                                        <form action="<?php echo e(route('coupons.store')); ?>" method="POST" id="coupon-form"
                                            ...
                                            <strong><?php echo e(@$errors->first('value')); ?></strong>
                                                ...
                                                <div class="col-xl-12">
                                                    <div class="primary_input mb-25">
                                                        <label class="primary_input_label"
                                                               for="coupon_user_id"><?php echo e(__('coupons.Coupon For')); ?></label>
                                                        <select
                                                            class="primary_select mb-25  <?php echo e(@$errors->has('coupon_user_id') ? ' is-invalid' : ''); ?>"
                                                            name="coupon_user_id" id="coupon_user_id">
                                                            <?php $__empty_1 = true; $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                                <option
                                                                    value="<?php echo e($user->id); ?>" <?php echo e(isset($edit)?($edit->coupon_user_id==$user->id?'selected':''):''); ?>><?php echo e($user->name); ?></option>
                ...
                <div class="col-lg-9">
                    <div class="main-title">
                        <h3 class="mb-20"><?php echo e(__('coupons.Personalized Coupons List')); ?></h3>
                    </div>
                            ...
                            <div class="">
                                <table id="lms_table" class="table Crm_table_active3">
                                    ...
                                    <tr>
                                        ...
                                        <th scope="col"><?php echo e(__('coupons.Coupon For')); ?></th>
                                    ...
                                    <?php $__currentLoopData = $coupons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $coupon): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td><?php echo e(@$coupon->coupon_user->name); ?></td>
                                            ...
                                            <td>
                                                ...
                                                <div class="dropdown CRM_dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right"
                                                        ...
                                                        <?php if(permissionCheck('coupons.personalized.edit')): ?>
                                                            <a class="dropdown-item edit_brand"
                                                               href="<?php echo e(route('coupons.personalized')); ?>?id=<?php echo e($coupon->id); ?>"><?php echo e(__('common.Edit')); ?></a>
                                                        <?php endif; ?>
                                                        <?php if(permissionCheck('coupons.personalized.delete')): ?>
...
<?php echo $__env->make('backend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hassangomaa/Documents/Laravel_projects/noLicenceLMS/LMS_Elingua/Modules/Coupons/Resources/views/personalized_coupons.blade.php ENDPATH**/ ?>