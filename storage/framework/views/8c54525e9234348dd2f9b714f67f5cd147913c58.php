                ...
                <div class="col-lg-12">
                    <div class="white_box mb_30">
                        <div class="white_box_tittle list_header">
                            <h4><?php echo e(__('student.Filter Enroll History')); ?></h4>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 col-xl-3 mt-30">
                                    <div class="search_course_btn text-center">
                                        <button type="submit"
                                                class="primary-btn radius_30px mr-10 fix-gr-bg"><?php echo e(__('common.Filter History')); ?></button>
                                    </div>
                                </div>
                            </div>
                        </form>
                ...
                <div class="col-12">
                    <div class="box_header common_table_header">
                        <div class="main-title d-md-flex">
                            <h3 class="mb-0 mr-30 mb_xs_15px mb_sm_20px"><?php echo e(__('student.Enrolled Student')); ?> <?php echo e(__('common.List')); ?></h3>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h3 class="text-center"><?php echo e(__('common.Are you sure to refund')); ?>?</h3>
                    <p class="text-center">
                    ...
                    <div class="col-lg-12 text-center">
                        <div class="mt-40 d-flex justify-content-between">
                            ...
                            <a id="refund_link" class="primary-btn semi_large2 fix-gr-bg"><?php echo e(__('common.Refund')); ?></a>
...
<?php echo $__env->make('backend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hassangomaa/Documents/Laravel_projects/noLicenceLMS/LMS_Elingua/resources/views/backend/student/enroll_student.blade.php ENDPATH**/ ?>