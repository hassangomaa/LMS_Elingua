    ...
    <section class="sms-breadcrumb mb-40 white-box">
        <div class="container-fluid">
            <div class="row justify-content-between">
                <h1><?php echo e(__('coupons.Coupons List')); ?></h1>
                <div class="bc-pages">
            ...
            <div class="row">
                        ...
                        <div class="col-12">
                            <div class="box_header common_table_header">
                                <div class="main-title d-md-flex mb-0">
                                    ...
                                    <?php if(isset($edit)): ?>
                                        <?php if(permissionCheck('coupons.store')): ?>
                                        ...
                                        <form action="<?php echo e(route('coupons.store')); ?>" method="POST" id="coupon-form"
                                                ...
                                                <div class="col-xl-12">
                                                    <div class="primary_input mb-25">
                                                        ...
                                                        <input name="title" id="title"
                                                               ...
                                                               type="text"
                                                               value="<?php echo e(isset($edit)?$edit->title:old('title')); ?>" <?php echo e($errors->has('title') ? 'autofocus' : ''); ?>>
                                            ...
                                            <strong><?php echo e(@$errors->first('title')); ?></strong>
                                                ...
                                                <div class="col-xl-12">
                                                    <div class="primary_input mb-25">
                                                        ...
                                                        <input name="code" id="code"
                                                               ...
                                                               value="<?php echo e(isset($edit)?$edit->code:old('code')); ?>" <?php echo e($errors->has('code') ? 'autofocus' : ''); ?>>
                                                ...
                                                <div class="col-xl-12">
                                                    <div class="primary_input mb-25">
                                                        <label class="primary_input_label"
                                                               for="number3"><?php echo e(__('coupons.Amount')); ?>
                ...
                <div class="col-lg-9 ">
                    <div class="main-title">
                        <h3 class="mb-20"><?php echo e(__('coupons.Coupons List')); ?></h3>
                    </div>
...
<?php echo $__env->make('backend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hassangomaa/Documents/Laravel_projects/noLicenceLMS/LMS_Elingua/Modules/Coupons/Resources/views/coupons.blade.php ENDPATH**/ ?>