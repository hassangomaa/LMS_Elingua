    ...
    <section class="sms-breadcrumb mb-40 white-box">
        <div class="container-fluid">
            <div class="row justify-content-between">
                <h1><?php echo e(__('coupons.Single Coupons List')); ?></h1>
                <div class="bc-pages">
            ...
            <div class="row">
                        ...
                        <div class="col-12">
                            <div class="box_header common_table_header">
                                <div class="main-title d-md-flex">
                                    <h3 class="mb-0 mr-30 mb_xs_15px mb_sm_20px"> <?php if(!isset($edit)): ?> <?php echo e(__('coupons.Add New Coupons')); ?> <?php else: ?> <?php echo e(__('common.Update')); ?> <?php endif; ?></h3>
                                    <?php if(isset($edit)): ?>
                                        <?php if(permissionCheck('coupons.single.store')): ?>
                                                ...
                                                <div class="col-xl-12">
                                                    <div class="primary_input mb-25">
                                                        <label class="primary_input_label"
                                                               for="category_id"><?php echo e(__('coupons.Select A Category')); ?>

                                                            <strong
                                                                class="text-danger">*</strong></label>
                                                        <select <?php echo e($errors->has('category_id') ? 'autofocus' : ''); ?>
                                                ...
                                                <div class="col-xl-12">
                                                    <div class="primary_input mb-25" id="subCategoryDiv">
                                                        ...
                                                        <select
                                                            ...
                                                            <?php if(isset($edit)): ?>
                                                                <?php $__currentLoopData = $edit->subcategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subcategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    <option
                                                                        value="<?php echo e($subcategory->id); ?>" <?php echo e($subcategory->id==$edit->subcateogry_id ? "selected":""); ?>><?php echo e($subcategory->name); ?></option>
                                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                            <?php else: ?>
                                                                <option
                                                                    data-display="<?php echo e(__('coupons.Select A Subcategory')); ?>"
                                                ...
                                                <div class="col-xl-12">
                                                    <div class="primary_input mb-25" id="CourseDiv">
                                                        ...
                                                        <select
                                                            ...
                                                            <?php if(isset($edit)): ?>
                                                                <?php $__currentLoopData = $edit->courses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    <option
                                                                        value="<?php echo e($course->id); ?>" <?php echo e($course->id==$edit->course_id ? "selected":""); ?>><?php echo e($course->title); ?></option>
                                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                            <?php else: ?>
                                                                <option
                                                                    data-display="<?php echo e(__('coupons.Select A Course')); ?>"
                                                    ...
                                                    <div class="primary_input mb-25">
                                                        <label class="primary_input_label"
                                                               for="number3"><?php echo e(__('coupons.Amount')); ?> <strong
                                                                class="text-danger">*</strong></label>
                                                        <input name="value" <?php echo e($errors->has('value') ? 'autofocus' : ''); ?>
                                                ...
                                                <div class="col-xl-12">
                                                    <div class="primary_input mb-25">
                                                        ...
                                                        <select
                                                            ...
                                                            name="type" id="type">
                                                            <option
                                                                value="1" <?php echo e(isset($edit)?($edit->type==1?'selected':''):''); ?>><?php echo e(__('coupons.Fixed')); ?></option>
                                                            <option
                                                                value="0" <?php echo e(isset($edit)?($edit->type==0?'selected':''):''); ?>><?php echo e(__('coupons.Percentage')); ?>
                ...
                <div class="col-lg-9 ">
                    <div class="main-title">
                        <h3 class="mb-20"><?php echo e(__('coupons.Single Coupons List')); ?></h3>
                    </div>
                                            ...
                                            <td>
                                                ...
                                                <div class="dropdown CRM_dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right"
                                                        ...
                                                        <?php if(permissionCheck('coupons.single.edit')): ?>
                                                            <a class="dropdown-item edit_brand"
                                                               href="<?php echo e(route('coupons.single')); ?>?id=<?php echo e($coupon->id); ?>"><?php echo e(__('common.Edit')); ?></a>
                                                        <?php endif; ?>
                                                        <?php if(permissionCheck('coupons.single.delete')): ?>
...
<?php echo $__env->make('backend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hassangomaa/Documents/Laravel_projects/noLicenceLMS/LMS_Elingua/Modules/Coupons/Resources/views/single_coupons.blade.php ENDPATH**/ ?>