                        ...
                        <div class="white_box_50px box_shadow_white">
                            ...
                            <div class="box_header d-block">
                                <div class="main-title d-flex flex-wrap">
                                    <h3 class="mb-0 mr-30 text-nowrap"><?php echo e(__('leave.Upload Staff Via CSV')); ?></h3>
                                    <div class="d-flex justify-content-end align-items-center  flex-wrap flex-grow-1">
                                        <ul class="d-flex flex-wrap">
                                            <li><a download class="primary-btn radius_30px mr-10 fix-gr-bg" href="<?php echo e(asset('public/uploads/staff.xlsx')); ?>"><i class="ti-import"></i>Sample File Download</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            <form action="<?php echo e(route("staffs.csv_upload_store")); ?>" method="POST" enctype="multipart/form-data" class="csvForm">
                                <?php echo csrf_field(); ?>
                                <div class="row form">
                                ...
                                <div class="col-12">
                                    <div class="submit_btn text-center ">
                                        <button class="primary-btn semi_large2 fix-gr-bg csvFormBtn" type="submit"><i
                                                class="ti-check"></i><?php echo e(__('leave.Upload CSV')); ?>
...
<?php echo $__env->make('backend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hassangomaa/Documents/Laravel_projects/noLicenceLMS/LMS_Elingua/Modules/SystemSetting/Providers/../Resources/views/staffs/upload_via_csv/create.blade.php ENDPATH**/ ?>